...
public class EmailManager:IEmailService
{
    ...
    public void SendEmailConfirmation(SendEmailConfirmationDto sendEmailConfirmationDto)
    {
        ...
        htmlContent = htmlContent.Replace("{{buttonLink}}", 
            MessagesHelper.Email.Confirmation.ButtonLink(sendEmailConfirmationDto.Email,sendEmailConfirmationDto.Token));
    ...
    private void Send(SendEmailDto sendEmailDto)
    {
        ...
        sendEmailDto.EmailAddressess.ForEach(emailAddress=>message.To.Add(emailAddress));
        ...
        client.UseDefaultCredentials = false;       //username ve password sağlanacak ona göre bağlan
